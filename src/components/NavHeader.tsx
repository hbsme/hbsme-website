      ...
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-5 text-sm font-medium">
          ...
          <a href="https://www.facebook.com/handbsme" target="_blank" rel="noopener noreferrer"
            aria-label="Facebook HBSME" className="text-gray-600 hover:text-blue-600 transition-colors">
          ...
          <a href="https://www.instagram.com/hbsme_officiel" target="_blank" rel="noopener noreferrer"
            aria-label="Instagram HBSME" className="text-gray-600 hover:text-pink-600 transition-colors">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
      ...
      {mobileOpen && (
        <nav className="md:hidden border-t border-gray-100 bg-white px-4 py-3 flex flex-col gap-1">
          ...
          <Link
            to="/inscription"
            onClick={() => setMobileOpen(false)}
            className="mt-2 block text-center bg-pink-700 text-white px-4 py-2.5 rounded-lg hover:bg-pink-800 transition-colors font-semibold text-sm"
          >
            Inscription
          </Link>
          <div className="mt-3 pt-3 border-t border-gray-100 flex gap-4 justify-center">
            <a href="https://www.facebook.com/handbsme" target="_blank" rel="noopener noreferrer"
