...
export const Route = createFileRoute('/entrainements')({
  head: () => ({
    meta: [
      ...
      { property: 'og:url', content: 'https://handball-saint-medard-deyrans.fr/entrainements' },
      { property: 'og:image', content: 'https://handball-saint-medard-deyrans.fr/logo-hbsme.png' },
      { property: 'og:type', content: 'website' },
      { property: 'og:locale', content: 'fr_FR' },
      { name: 'twitter:card', content: 'summary' },
    ],
    links: [{ rel: 'canonical', href: 'https://handball-saint-medard-deyrans.fr/entrainements' }],
  }),
