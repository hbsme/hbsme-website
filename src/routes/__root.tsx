...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: `Club de handball de Saint-Médard d\'Eyrans (Gironde). Résultats, prochains matchs, classements et actualités.` },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          sameAs: [
            'https://www.facebook.com/handbsme',
            'https://www.instagram.com/hbsme_officiel',
          ],
        }),
      },
    ],
